...
public interface InvestmentRepository extends JpaRepository<Investment, Long> {
	...
	public Page<InvestmentDTO> pagedSearchByClient(@Param("id") Long id, Pageable pageable);
	
	@Query(" SELECT i FROM Investment i WHERE i.client = :id")
	public Page<InvestmentDTO> pagedSearchByBroker(@Param("id") Long id, Pageable pageable);
